...
class RecipeTest < ActiveSupport::TestCase
  def setup
    ...
    # @recipe = Recipe.new(name: 'vegetable', description: 'great vegetable recipe', chef: @chef)
    @recipe = Recipe.new(name: 'vegetable', description: 'great vegetable recipe', chef_id: @chef.id)
  end
